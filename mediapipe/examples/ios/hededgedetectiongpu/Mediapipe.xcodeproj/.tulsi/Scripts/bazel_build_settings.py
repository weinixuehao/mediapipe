...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_chenlong/46cfe12d82525b8b2b43cf38d2da2eb7/execroot/mediapipe',
    'ios_x86_64',
    {
        'watchos_arm64_32': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/user/Library/Application Support/Tulsi/0.20200624.88/Bazel',
