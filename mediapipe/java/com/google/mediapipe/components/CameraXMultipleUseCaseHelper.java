 ...
 */
public class CameraXMultipleUseCaseHelper extends CameraHelper {
  ...
  public void startCamera(
    ...
    ImageCaptureConfig imgCaptureConfig = new ImageCaptureConfig.Builder()
            ...
            .build();
    mImageCapture = new ImageCapture(imgCaptureConfig);
    ...
    CameraX.unbindAll();
    CameraX.bindToLifecycle(/*lifecycleOwner=*/ (LifecycleOwner) context, mImageCapture, preview);
  }

  public void takePicture(Context context, File file, ImageCapture.OnImageSavedListener onImageSavedListener) {
    mImageCapture.takePicture(file, ContextCompat.getMainExecutor(context), onImageSavedListener);
  }
